...
module.exports = {
  rules: {
    'param-names': __webpack_require__(1030),
    'no-return-wrap': __webpack_require__(1032),
    'always-return': __webpack_require__(1035),
    'catch-or-return': __webpack_require__(1036),
    'prefer-await-to-callbacks': __webpack_require__(1037),
    'prefer-await-to-then': __webpack_require__(1038),
    'no-native': __webpack_require__(1039),
    'no-callback-in-promise': __webpack_require__(1040),
    'no-promise-in-callback': __webpack_require__(1045),
    'no-nesting': __webpack_require__(1047),
    'avoid-new': __webpack_require__(1048),
    'no-new-statics': __webpack_require__(1049),
    'no-return-in-finally': __webpack_require__(1050),
    'valid-params': __webpack_require__(1051)
  },
  rulesConfig: {
    'param-names': 1,
    'always-return': 1,
...
const getDocsUrl = __webpack_require__(1031)
...
const getDocsUrl = __webpack_require__(1031)
const isPromise = __webpack_require__(1033)
...
const PROMISE_STATICS = __webpack_require__(1034)
...
const getDocsUrl = __webpack_require__(1031)
const hasPromiseCallback = __webpack_require__(1041)
const isInsidePromise = __webpack_require__(1042)
const isCallback = __webpack_require__(1043)
...
const isNamedCallback = __webpack_require__(1044)
...
const getDocsUrl = __webpack_require__(1031)
const isPromise = __webpack_require__(1033)
const isInsideCallback = __webpack_require__(1046)
